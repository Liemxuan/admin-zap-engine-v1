            ...
            <div className="p-6 space-y-4">
                <div className="flex items-center justify-between gap-4">
                    <div className="min-w-0">
                        <h1 className="text-lg font-bold text-slate-900 whitespace-nowrap truncate">{t('location.title')}</h1>
                        <p className="text-xs text-slate-500 whitespace-nowrap">{t('location.subtitle')}</p>
                    </div>
                    <button
                        onClick={() => navigate(`/${language}/location/create`)}
